                    ...
                    <div class="payment subcontain">
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <input type="number" id="grand_total" placeholder="Total Amount">
                            </div>
                            <div class="form-row">
                                <label>Advance Amount:</label>
                                <input type="number" id="advance_amount" placeholder="0">
                            </div>
                            <div class="form-row">
                                <label>Amount to be Paid:</label>
                                <input type="number" id="amounttobe_paid" placeholder="0">
                            </div>
                            <div class="form-row">
                                <label>Recovery Amount:</label>
                                <input type="number" id="recovery_amount" placeholder="0">
                            </div>
                            <div class="form-row">
                                <label>Total Amount to be Paid:</label>
                                <input type="number" id="totalamount_paid" placeholder="0">
                            </div>
                            <div class="form-row">
